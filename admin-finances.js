...
function financeActionsPanel(item) {
  ...
  return `<section class="finances-actions-panel" aria-label="Actions financieres"><div><p class="section-kicker">Suite logique</p><h3>Arbitrer, justifier, reporter</h3><p>Les actions rapides aident a suivre ce qui peut etre engage, depose ou transmis a un financeur.</p></div><div class="finances-actions-grid"><button class="btn primary" type="submit" form="finances-detail-form">Enregistrer</button><button class="btn secondary" type="button" data-finances-action="review">A reviser</button><button class="btn secondary" type="button" data-finances-action="validate">Valider</button><button class="btn secondary" type="button" data-finances-action="reject">Refuser / bloquer</button><button class="btn secondary" type="button" data-finances-action="archive">Archiver</button><button class="btn secondary" type="button" data-finances-action="followup">${escapeHtml(followupLabel)}</button></div><nav class="finances-linked-nav" aria-label="Modules lies"><a href="admin-dossiers">Dossiers</a><a href="admin-documents">Justificatifs</a><a href="admin-governance">Decision</a><a href="admin-impact">Impact</a><a href="admin-crm">Financeurs</a></nav></section>`;
}
