...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "GET") {
      const [signalements, materiaux, partenaires, antennes, biens_candidats, projets, projets_financement, investisseurs, mecenes, activity_log] = await Promise.all([
      ...
      return sendJson(res, 200, { data: { signalements, materiaux, partenaires, antennes, biens_candidats, projets, projets_financement, investisseurs, mecenes, activity_log } });
    }
    if (req.method === "PATCH") {
