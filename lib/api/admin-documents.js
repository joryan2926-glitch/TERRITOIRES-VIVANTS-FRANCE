...
const INTERNAL_KIT_FILES = [
  ["Index", "00 - Index", "Sommaire de la bibliotheque et logique de classement interne.", "documents/kit-formulaires-conventions-tvf/00-index/tvf-index-bibliotheque-formulaires-conventions.docx"],
  ...
  ["Collectivite / territoire", "01 - Formulaires", "Preparer une demande de rendez-vous, diagnostic ou cooperation.", "documents/kit-formulaires-conventions-tvf/02-collectivite-territoire/tvf-f-02-demande-collectivite---territoire-de-cooperation.docx"],
  ...
  ["Entreprise / contribution", "01 - Formulaires", "Recueillir une proposition de materiaux, local, transport, competences ou soutien.", "documents/kit-formulaires-conventions-tvf/05-entreprise-partenariat/tvf-f-05-demande-entreprise---cooperation-territoriale.docx"],
  ...
  ["Convention cooperation entreprise", "02 - Conventions", "Formaliser contribution RSE, visibilite, reporting et limites.", "documents/kit-formulaires-conventions-tvf/13-conventions-types/tvf-conv-04-convention-type-de-cooperation-entreprise.docx"],
  ...
  ["Courriers types prets a envoyer", "04 - Courriers", "Modeles de courriers ranges par interlocuteur et besoin.", "documents/kit-formulaires-conventions-tvf/15-courriers-prets-a-envoyer/tvf-cour-01-courriers-types-demandes.docx"],
];
...
function descriptionFromKitPath(relativePath) {
  ...
  if (file.includes("index")) return "Index de classement et logique d'utilisation de la bibliotheque interne.";
  ...
  if (file.startsWith("tvf-cour-")) return "Courriers types prets a adapter pour demandes, relances et partenariats.";
...
async function handler(req, res) {
  ...
  try {
    ...
    sendJson(res, setupError ? 503 : statusCode, { ok: false, error: setupError ? setupError.message : statusCode >= 500 ? "Documents temporairement non charges : v̩rifiez la configuration Supabase du module." : error.message, code: setupError?.code || error.code || undefined, details: process.env.NODE_ENV === "development" ? error.details || error.message : undefined });
  }
}
