...
async function handler(req, res) {
  ...
  try {
    ...
    sendJson(res, statusCode, { ok: false, error: statusCode >= 500 ? "Procedures temporairement non chargees : vérifiez la configuration Supabase du module." : error.message, code: error.code || undefined, details: process.env.NODE_ENV === "development" ? error.details || error.message : undefined });
  }
}
