...
| Dashboard public admin | `/api/dashboard?range=30&status=all&priority=all&category=all` | OK | 988 ms | Lecture valide |
...
| E-mails intelligents | `/api/admin-emails?entity=dashboard` | OK | 78 ms | Lecture valide |
| Dossiers | `/api/admin-cases?entity=dashboard` | OK | 71 ms | Lecture valide |
| Taches / agenda | `/api/admin-work?entity=dashboard` | OK | 292 ms | Lecture valide |
...
| Territoires locaux | `/api/admin-branches?entity=dashboard` | OK | 133 ms | Lecture valide |
| Impact | `/api/admin-impact?entity=dashboard` | OK | 78 ms | Lecture valide |
| Finances | `/api/admin-finances?entity=dashboard` | OK | 151 ms | Lecture valide |
| Decisions | `/api/admin-governance?entity=dashboard` | OK | 143 ms | Lecture valide |
...
| Connaissances | `/api/admin-knowledge?entity=dashboard` | OK | 130 ms | Lecture valide |
