...
| Dashboard public admin | `/api/dashboard?range=30&status=all&priority=all&category=all` | OK | 1104 ms | Lecture valide |
...
| Taches / agenda | `/api/admin-work?entity=dashboard` | OK | 111 ms | Lecture valide |
...
| Observatoire | `/api/admin-observatoire?entity=dashboard` | OK | 123 ms | Lecture valide |
| Antennes | `/api/admin-branches?entity=dashboard` | OK | 133 ms | Lecture valide |
| Impact | `/api/admin-impact?entity=dashboard` | OK | 84 ms | Lecture valide |
| Finances | `/api/admin-finances?entity=dashboard` | OK | 84 ms | Lecture valide |
| Gouvernance | `/api/admin-governance?entity=dashboard` | OK | 209 ms | Lecture valide |
| Risques / conformite | `/api/admin-risks?entity=dashboard` | OK | 89 ms | Lecture valide |
| Utilisateurs / roles | `/api/admin-users?entity=dashboard` | OK | 139 ms | Lecture valide |
| Parametres | `/api/admin-settings?entity=dashboard` | OK | 161 ms | Lecture valide |
| Connaissances | `/api/admin-knowledge?entity=dashboard` | OK | 133 ms | Lecture valide |
| Assistant IA | `/api/admin-ai?entity=dashboard` | OK | 138 ms | Lecture valide |
