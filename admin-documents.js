...
bindEvents();
if (token()) { showApp(); loadInitialDocumentsApp().catch((error) => { setToken(""); showLogin(); setStatus(error.message, "error"); }); } else { showLogin(); }
