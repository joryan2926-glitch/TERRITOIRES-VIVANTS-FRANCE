...
const pageMeta = {
  ...
  "tvf-enjeux-saint-etienne.html": ["Observatoire", "TVF r&eacute;pond aux enjeux de Saint-&Eacute;tienne"],
  "fiches-projets-territorialisees.html": ["Observatoire", "Fiches projet territorialis&eacute;es"],
  "etude-impact-saint-etienne.html": ["Observatoire", "Etude d'impact Saint-Etienne"],
  "sources-etude-saint-etienne.html": ["Observatoire", "Sources Saint-Etienne"],
...
const statusMeta = {
  ...
  "tvf-enjeux-saint-etienne.html": ["pilot", "Alignement territorial"],
  "fiches-projets-territorialisees.html": ["pilot", "Outil op&eacute;rationnel"],
  "etude-impact-saint-etienne.html": ["pilot", "Etude d'impact"],
  "sources-etude-saint-etienne.html": ["reference", "Registre des sources"],
  "charte-ethique.html": ["reference", "Charte en pr&eacute;figuration"],
...
const observatoryMenu = dropdown("Observatoire", "observatoire-national.html", "Observatoire", "Des donn&eacute;es sourc&eacute;es, dat&eacute;es et territorialis&eacute;es.", [
  ...
  megaLink("tvf-enjeux-saint-etienne.html", "TVF et les enjeux de Saint-&Eacute;tienne", "Aligner l'action TVF avec les priorit&eacute;s publiques locales.", "observe"),
  megaLink("fiches-projets-territorialisees.html", "Fiches projet territorialis&eacute;es", "Transformer un bien, un besoin et un financement en dossier op&eacute;rationnel.", "observe"),
  megaLink("etude-impact-saint-etienne.html", "&Eacute;tude d'impact Saint-&Eacute;tienne", "Donn&eacute;es, projections et indicateurs de suivi.", "observe"),
  megaLink("sources-etude-saint-etienne.html", "Sources Saint-&Eacute;tienne", "Registre des donn&eacute;es officielles mobilis&eacute;es.", "observe"),
