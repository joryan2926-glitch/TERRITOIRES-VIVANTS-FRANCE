...
const modules = [
  ...
  { key: "governance", label: "Gouvernance", group: "Pilotage", page: "admin-governance.html", js: "admin-governance.js", api: "lib/api/admin-governance.js", test: "tests/admin-governance-api.test.js", sql: "supabase/tvf-os-governance.sql", verification: "supabase/tvf-os-governance-verification.sql", seed: "supabase/tvf-os-governance-test-data.sql", doc: "documents/module-gouvernance-decisions-tvf-os.md", report: "documents/rapport-validation-gouvernance-decisions-tvf-os.md", priority: "P2" },
  { key: "risks", label: "Risques / conformite", group: "Pilotage", page: "admin-risks.html", js: "admin-risks.js", api: "lib/api/admin-risks.js", test: "tests/admin-risks-api.test.js", sql: "supabase/tvf-os-risks.sql", verification: "supabase/tvf-os-risks-verification.sql", seed: "supabase/tvf-os-risks-test-data.sql", doc: "documents/module-risques-conformite-tvf-os.md", report: "documents/rapport-validation-risques-conformite-tvf-os.md", priority: "P2" },
  { key: "users", label: "Utilisateurs / roles", group: "Systeme", page: "admin-users.html", js: "admin-users.js", api: "lib/api/admin-users.js", test: "tests/admin-users-api.test.js", sql: "supabase/tvf-os-users.sql", verification: "supabase/tvf-os-users-verification.sql", seed: "supabase/tvf-os-users-test-data.sql", doc: "documents/module-utilisateurs-roles-permissions-tvf-os.md", report: "documents/rapport-validation-utilisateurs-roles-permissions-tvf-os.md", priority: "P1" },
  { key: "settings", label: "Parametres", group: "Systeme", page: "admin-settings.html", js: "admin-settings.js", api: "lib/api/admin-settings.js", test: "tests/admin-settings-api.test.js", sql: "supabase/tvf-os-settings.sql", verification: "supabase/tvf-os-settings-verification.sql", seed: "supabase/tvf-os-settings-test-data.sql", doc: "documents/module-parametres-tvf-os.md", report: "documents/rapport-validation-parametres-tvf-os.md", priority: "P1" },
  { key: "activity", label: "Journal activite", group: "Systeme", page: "admin-activity.html", js: "admin-activity.js", api: "lib/api/admin-audit.js", test: "tests/admin-audit-api.test.js", sql: "supabase/tvf-os-audit-transversal.sql", doc: "documents/rapport-conformite-tvf-os.md", report: "documents/rapport-conformite-tvf-os.md", priority: "P1" },
  { key: "knowledge", label: "Connaissances", group: "Systeme", page: "admin-knowledge.html", js: "admin-knowledge.js", api: "lib/api/admin-knowledge.js", test: "tests/admin-knowledge-api.test.js", sql: "supabase/tvf-os-knowledge.sql", verification: "supabase/tvf-os-knowledge-verification.sql", seed: "supabase/tvf-os-knowledge-test-data.sql", doc: "documents/module-knowledge-tvf-os.md", report: "documents/rapport-validation-knowledge-tvf-os.md", priority: "P2" },
  { key: "ai", label: "Assistant IA", group: "Systeme", page: "admin-ai.html", js: "admin-ai.js", api: "lib/api/admin-ai.js", test: "tests/admin-ai-api.test.js", sql: "supabase/tvf-os-ai.sql", verification: "supabase/tvf-os-ai-verification.sql", seed: "supabase/tvf-os-ai-test-data.sql", doc: "documents/module-assistant-ia-tvf-os.md", report: "documents/rapport-validation-assistant-ia-tvf-os.md", priority: "P2" },
];
...
lines.push("4. Decision : validation humaine, risques, gouvernance, financement, convention.");
lines.push("5. Execution : terrain, antenne, cartographie, suivi des actions.");
lines.push("6. Preuve : impact, reporting, documents, base de connaissances.");
lines.push("");
...
lines.push("| P2 | Formaliser les exports mensuels impact / demandes / partenaires | Reporting financeur et gouvernance |");
