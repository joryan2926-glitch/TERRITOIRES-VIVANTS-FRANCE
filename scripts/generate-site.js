...
function formSection() {
  return `<section class="section" ${sectionAttrs("Préparer une situation", "proposer")}><div class="container form-panel"><div><p class="section-kicker">Premier contact</p><h2>Préparer une situation</h2><p>Utilisez ce bloc comme guide de préparation avant d'écrire à TVF. L'objectif est de rassembler les informations utiles pour accélérer l'orientation de votre demande.</p></div><form aria-describedby="preparation-note"><label for="prep-profile">Votre profil</label><select id="prep-profile" name="profil"><option value="collectivite">Collectivité</option><option value="proprietaire">Propriétaire</option><option value="entreprise">Entreprise</option><option value="association">Association</option><option value="citoyen">Citoyen</option></select><label for="prep-subject">Objet</label><input id="prep-subject" name="objet" type="text" autocomplete="off" placeholder="Ex. logement vacant, matériaux, partenariat"><label for="prep-message">Message</label><textarea id="prep-message" name="message" placeholder="Décrivez le besoin, le lieu, les acteurs concernés et les délais."></textarea><p class="form-note" id="preparation-note">Ce bloc sert à préparer votre demande. Aucune donnée n'est transmise automatiquement depuis cette page.</p><a class="btn primary" href="${hrefFor("contact.html")}">Passer par la page contact</a></form></div></section>`;
}

function contactSection() {
  return `<section class="section" ${sectionAttrs("Décrivez votre demande", "contact-form")}><div class="container form-panel"><div><p class="section-kicker">Message</p><h2>Décrivez votre demande</h2><p>Indiquez votre profil, votre commune, le type de bien ou de coopération, et les informations déjà disponibles.</p></div><form aria-describedby="contact-note"><label for="contact-name">Nom / structure</label><input id="contact-name" name="nom" type="text" autocomplete="name" placeholder="Votre nom ou organisme"><label for="contact-email">E-mail</label><input id="contact-email" name="email" type="email" autocomplete="email" inputmode="email" placeholder="contact@exemple.fr"><label for="contact-message">Message</label><textarea id="contact-message" name="message" autocomplete="off" placeholder="Votre message"></textarea><p class="form-note" id="contact-note">Ce formulaire prépare les informations utiles. L'envoi définitif doit être réalisé via le canal de contact officiel de TVF.</p><button class="btn primary" type="button">Préparer l'envoi</button></form></div></section>`;
}
