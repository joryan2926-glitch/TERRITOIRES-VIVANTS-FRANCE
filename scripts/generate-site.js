...
const pages = [
    ...
    sections: [
      ...
      sectionIntro(
        ...
        [
          ...
          ["S\u00e9curiser", "Pr\u00e9parer convention, orientation professionnelle, assurance, responsabilit\u00e9s et limites. Aucun mandat immobilier sans cadre habilit\u00e9."],
        ]
      ),
  ...
  },
  {
    ...
    sections: [
      ...
      cards("À qui s'adressent les actions ?", "Chaque public doit comprendre immédiatement où il intervient dans la chaîne de revitalisation.", [
        ...
        ["Propriétaires", "Pr\u00e9qualifier un bien, rassembler les pi\u00e8ces et explorer les usages possibles sans mandat immobilier.", "proprietaires.html"],
  ...
  },
  {
    ...
    sections: [
      ...
      sectionIntro(
        "Accompagnement immobilier de préqualification",
        "Avant toute décision, TVF peut aider un propriétaire à transformer une situation floue en dossier lisible : comprendre le bien, rassembler les informations utiles, identifier les usages possibles, mesurer les limites et orienter vers les bons professionnels. Ce service reste un accompagnement de cadrage et ne constitue pas un mandat de transaction, de location ou de gestion immobilière.",
        [
          ["Visite de préqualification", "Observer l'état apparent, les accès, les risques visibles et les usages possibles avec accord écrit du propriétaire."],
          ["Fiche bien", "Centraliser adresse, photos, contraintes, pièces disponibles, attentes du propriétaire et potentiel de remise en usage."],
          ["Scénario d'usage", "Comparer logement, local associatif, commerce, atelier, stockage, formation, occupation temporaire ou réorientation."],
          ["Orientation qualifiée", "Diriger vers notaire, architecte, diagnostiqueur, artisan, avocat, agent immobilier ou gestionnaire habilité lorsque le sujet l'exige."],
        ]
      ),
      tableSection("Services possibles pour un propriétaire", "Ces services peuvent être proposés sans carte professionnelle lorsqu'ils restent de l'accompagnement, de la qualification, de la documentation ou de l'orientation, sans entremise immobilière rémunérée.", [
        ["Service", "Ce que TVF peut faire", "Livrable utile"],
        ["Préqualification du bien", "Visiter avec autorisation, relever l'état apparent, les accès, les contraintes visibles et les informations manquantes", "Fiche de préqualification"],
        ["Dossier propriétaire", "Rassembler titre, photos, diagnostics existants, plans, taxe foncière, devis, règlement de copropriété et autorisations utiles", "Liste de pièces et dossier classé"],
        ["Analyse d'usage", "Identifier les usages compatibles avec l'état du bien, le territoire, les besoins locaux et les limites du propriétaire", "Note de scénarios"],
        ["Pré-diagnostic travaux", "Qualifier les besoins visibles : nettoyage, débarras, peinture, sols, menuiseries, sanitaires ou petits aménagements", "Grille de besoins et points à expertiser"],
        ["Recherche de ressources", "Identifier matériaux de réemploi, partenaires, bénévoles, financeurs ou compétences mobilisables", "Plan de mobilisation"],
        ["Projet de convention", "Préparer les principes d'une convention d'étude, d'usage, de mise à disposition ou de coopération à faire valider", "Trame à relire juridiquement"],
      ]),
      tableSection("Limites à respecter sans carte professionnelle", "TVF doit rester dans un cadre sûr tant que les autorisations nécessaires ne sont pas obtenues. Cette prudence protège le propriétaire, l'association et les futurs usagers.", [
        ["TVF peut", "TVF ne doit pas faire sans cadre habilité"],
        ["Aider à présenter le bien", "Signer un mandat de vente, de location ou de gestion"],
        ["Orienter vers un professionnel", "Négocier un bail, un loyer, une vente ou une commission"],
        ["Préparer une note d'usage", "Encaisser loyers, charges, dépôts de garantie ou fonds pour le compte d'autrui"],
        ["Organiser une réunion de cadrage", "Administrer le bien comme une agence ou un gestionnaire locatif"],
        ["Préparer un projet de convention", "Promettre un rendement financier ou une mise en location certaine"],
      ]),
  ...
  },
  {
    ...
    sections: [
      ...
      tableSection("Place du propriétaire dans la méthode", "Lorsqu'une demande vient d'un propriétaire, la méthode commence par la clarification du bien et de l'intention, avant tout engagement.", [
        ["Étape", "Question posée", "Sortie attendue"],
        ["Comprendre", "Pourquoi le bien est-il inutilisé et quelle limite le propriétaire veut-il respecter ?", "Fiche contact et intention"],
        ["Documenter", "Quelles pièces existent déjà et quels points doivent être vérifiés ?", "Liste de pièces"],
        ["Scénariser", "Quels usages sont utiles, faisables et compatibles avec le cadre du bien ?", "Note de scénarios"],
        ["Sécuriser", "Faut-il un professionnel habilité, une expertise, une assurance ou une validation juridique ?", "Orientation ou convention à valider"],
      ]),
