...
const checks = [
  ...
  { key: "work", label: "Taches", handler: require("../lib/api/admin-work"), url: "/api/admin-work?entity=dashboard" },
  ...
  { key: "knowledge", label: "Base interne", handler: require("../lib/api/admin-knowledge"), url: "/api/admin-knowledge?entity=dashboard" },
